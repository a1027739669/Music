      ...
      <#list albumPage.content as album>
        <li class="playlist__item"
			...
			<span class="playlist__title_txt">
				<a href="https://y.qq.com/n/yqq/album/002rmKH83FOcnD.html#stat=y_new.album_lib.album_name"
                   onclick="" class="js_album"
                   data-stat="y_new.album_lib.album_name" data-albummid="002rmKH83FOcnD" title="此情此景">${album.album_name}</a>
			</span>
                </h4>
...
<div class="mod_page_nav js_pager_comment">
    ...
    <#elseif (albumPage.totalPages>=9)>
        ...
        <#if ((albumPage.getNumber()+1)<=4)>
            ...
            <strong class="more">...</strong>
            <a href="javascript:;" class="js_pageindex" hidefocus="" onclick="toPage(${albumPage.totalPages},${currentCate})">${albumPage.totalPages}</a>
