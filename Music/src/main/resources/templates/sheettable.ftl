    ...
    <div class="mod_page_nav js_pager_comment">
        ...
        <#elseif (sheetsPage.totalPages>1)&&(sheetsPage.totalPages<=4)>
            <#if ((sheetsPage.getNumber()+1)!=1)>
                <a href="javascript:;" class="next js_pageindex" title="上一页"
                   hidefocus="" onclick="toList(${sheetsPage.getNumber()},${currentRankId},'${currentLabel?js_string}')"><span>&lt;</span></a>
            </#if>
            ...
            <#if ((sheetsPage.getNumber()+1)!=sheetsPage.totalPages)>
                <a href="javascript:;" class="next js_pageindex" title="下一页"
                   hidefocus="" onclick="toList(${sheetsPage.getNumber()+2},${currentRankId},'${currentLabel?js_string}')"><span>&gt;</span></a>
            </#if>
        <#elseif (sheetsPage.totalPages>=5)&&(sheetsPage.totalPages<9)>
            ...
            <#if (sheetsPage.getNumber()>3)>
                <a href="javascript:;" class="js_pageindex" hidefocus="" onclick="toList(1,${currentRankId},'${currentLabel?js_string}')">1</a>
            ...
            <#else>
                ...
                <strong class="more">...</strong>
                <a href="javascript:;" class="js_pageindex" hidefocus="" onclick="toList(9,${currentRankId},'${currentLabel?js_string}')">9</a>
            </#if>
            <#if ((sheetsPage.getNumber()+1)!=sheetsPage.totalPages)>
                <a href="javascript:;" class="next js_pageindex" title="下一页"
                   hidefocus="" onclick="toList(${sheetsPage.getNumber()+2},${currentRankId},'${currentLabel?js_string}')"><span>&gt;</span></a>
