...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/mystatic/kuwocss.css">
...
<header class="header">
    <div class="header-box">
        ...
        <ul class="header-top-nav">
            ...
            <li class="top-nav-item active"><a href="/guest/sheetlist" class="tnav-link" title="音乐号">分类歌单</a></li>
...
<div class="main">
    <div class="mod_playlist_tag" id="taglist">
            ...
            <div class="tag__list">
                <h3 class="playlist_tag__tit c_tx_thin">标签</h3>
                <#list labelList as label>
                    <a onclick="changeLabel(1,1,'${label.label_name?js_string}')" class="tag__item" data-id="area|1">${label.label_name}</a>
                </#list>
            </div>
    ...
    <div class="mod_part_detail">
        <div class="part_detail__hd">
            ...
            <div class="part_switch" id="sortbox" aria-label="排列方式"><a title="推荐" id="tuijian"
                                                                       class="part_switch__item js_sort part_switch__item--left part_switch__item--select"
                                                                       href="javascript:void(0);"
                                                                       onclick="tuijianSheet()" data-sort="5">推荐</a><a
                        title="最新" class="part_switch__item part_switch__item--right js_sort" id="newSheet"
                        href="javascript:void(0);" onclick="newSheet()"
                        data-sort="2">最新</a></div>
        </div>
        <div class="mod_playlist mod_playlist--all" id="playlistAll">
        </div>
    </div>
</div>
</div>
                        ...
                        <div class="popup-login-wrapper">
                            <div id="login-container">
                                <div class="login-tab"><span class="current"
                                    >账户登录</span><span
                                            class=""
                                            data-spm-anchor-id="a2oj1.12028025.0.i1.54776ee1fdgM1B"></span></div>
                                <form id="loginform">
...
<script type="text/javascript">
    ...
    function tuijianSheet() {
        $("#newSheet").removeClass("part_switch__item--select");
        $("#tuijian").addClass("part_switch__item--select");
        toList(1, 1,'${tempLabel?js_string}');
    }

    function newSheet() {
        $("#tuijian").removeClass("part_switch__item--select");
        $("#newSheet").addClass("part_switch__item--select");
        toList(1, 2,'${tempLabel?js_string}');
    }
    ...
    function toList(page, rankmethod,label) {
        $.ajax({
            ...
            success: function (data) {
                $("#playlistAll").empty();
                $("#playlistAll").append(data);
            }
        });
    }
    function changeLabel(page, rankmethod,label) {
        toList(page, rankmethod,label);
    }
</script>
<script type="text/javascript">
    function playAll() {
