    ...
    <form class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${singer.singerName}" placeholder="" id="username"
                       name="username">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" value="${singer.birthday}"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                ...
                <div class="radio-box">
                    <#if singer.sex=='女'>
                        <input type="radio" id="sex-2" name="sex" checked value="女">
                    <#else >
                ...
                <div class="radio-box">
                    <#if singer.sex=='组合'>
                        <input type="radio" id="sex-3" name="sex" checked value="组合">
                    <#else >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="btn-upload form-group">
				...
				<input type="file" value="/upload/${singer.singerImg}" name="file-2" class="input-file" id="imagefile">
				</span></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="city" id="city">
                    ...
                    <#if singer.country=='请选择地区'>
                        <option value="" selected>请选择地区</option>
                        <#else >
                        <option value="">请选择地区</option>
                    </#if>
                    <#if singer.country=='内地'>
                        <option selected value="内地">内地</option>
                            <#else >
                        <option value="内地">内地</option>
                    </#if>
                    <#if singer.country=='港台'>
                        <option selected value="港台">港台</option>
                        <#else >
                        <option value="港台">港台</option>
                    </#if>
                    <#if singer.country=='日本'>
                        <option selected value="日本">日本</option>
                        <#else >
                        <option value="日本">日本</option>
                    </#if>
                    <#if singer.country=='韩国'>
                        <option selected value="韩国">韩国</option>
                    <#else >
                        <option value="韩国">韩国</option>
                    </#if>
                    <#if singer.country=='欧美'>
                        <option selected value="欧美">欧美</option>
                        <#else >
                        ...
                        <dl class="cl permission-list2" id="permission-list2">
                            <#list labelList as label>
                                <dt>
                                    <label class="">
                                        <#assign x=0 >
                                        <#list singerLabels as singerLabel>
                                            <#if singerLabel==label.label_name>
                                                <#assign x=1>
                                            </#if>
                                        </#list>
                                        <#if x==0>
                                    ...
                                    <#else >
                                        <input type="checkbox" checked value="${label.label_name}"
                                               name="user-Character-1-0" id="${label.id}">
                                        ${label.label_name}</label>
                                    </#if>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="beizhu" cols="" rows="" class="textarea" placeholder="" id="introduction"
                          value="">${singer.introduction}</textarea>
