...
<article class="cl pd-20">
    <form class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>专辑名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${album.albumName}" placeholder="" id="albumname" name="albumname">
            </div>
        </div>
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="singername" id="singername">
                    ...
                    <#list singerList as singer>
                        <#if album.album_singer==singer.id>
                            <option selected value="${singer.getId()}">${singer.singerName}</option>
                            <#else >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" value="${album.album_release}"
                        ...
                        <dl class="cl permission-list2" id="permission-list2">
                            <#list labelList as label>
                                <dt>
                                    <label class="">
                                        <#assign x=0 >
                                        <#list albumLabels as singerLabel>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="beizhu" cols="" rows="" class="textarea" placeholder="" id="introduction">${album.introduction}</textarea>
...
<script type="text/javascript">
    ...
    function ajaxsubmit() {
        ...
        myform.append('albumname', albumname);
        ...
        myform.append('albumId',${album.albumId});
        $.ajax({
            url: "/back/tomodifyalbum",
            type: "POST",
            data: myform,
            async: false,
            contentType: false,
