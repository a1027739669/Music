...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 歌手管理 <span
                class="c-gray en">&gt;</span> 歌手列表<a class="btn btn-success radius r"
        ...
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a  onclick="deleteAll()"
                                ...
                                class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;"
                                                                              onclick="member_edit('编辑','/back/editsinger','4','','510')"
                                                                              class="btn btn-primary radius"><i
                                class="Hui-iconfont">&#xe600;</i> 添加歌手</a></span> <span
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <#list singerList as singer>
                        <tr class="text-c">
                            <td><input type="checkbox" value="${singer.id}" name="hello"></td>
                            <td>${singer.id}</td>
                            <td><u style="cursor:pointer" class="text-primary"
                                   onclick="member_show('张三','member-show.html','10001','360','400')">${singer.singerName}</u>
                            </td>
                            <td>${singer.birthday}</td>
                            <td>  <#if singer.introduction?length gt 33>
                                    ${singer.introduction?substring(0,30)}...
                                <#else>
                                    ${singer.introduction!}
                                </#if>
                            </td>
                            <td>${singer.country}</td>
                            <td><img src="/upload/${singer.singerImg}" width="50px" height="50px"></td>
                            <td>${singer.sex}</td>
                            <td>${singer.labels}</td>
                            <td class="td-manage"><a title="编辑" href="javascript:;"
                                                     onclick="member_edit('编辑','/back/modifysinger?singerId=${singer.id}','4','','510')"
