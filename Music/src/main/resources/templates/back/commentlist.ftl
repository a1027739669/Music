    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a  onclick="deleteAll()"
                                ...
                                class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span> <span
                        class="r">共有数据：<strong>${commentList ? size}</strong> 条</span></div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <#list commentList as comment>
                        <tr class="text-c">
                            <td><input type="checkbox" value="${comment.comment_id}" name="hello"></td>
                            <td>${comment.comment_id}</td>
                            <td><u style="cursor:pointer" class="text-primary"
                                   onclick="member_show('张三','member-show.html','10001','360','400')">${comment.getUser().nicheng}</u>
                            </td>
                            <td>${comment.commentDate}</td>
                            <td>${comment.getSong().song_name}</td>
                            <td>  <#if comment.comment_text?length gt 33>
                                    ${comment.comment_text?substring(0,30)}...
                                <#else>
                            ...
                            <td class="td-manage">
                                <a title="删除" href="javascript:;" data-id="${comment.comment_id}" onclick="member_del(this,${comment.comment_id})" class="ml-5"
                                   style="text-decoration:none" id="deletetest"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                        </tr>
                    </#list>
                    </tbody>
                </table>
