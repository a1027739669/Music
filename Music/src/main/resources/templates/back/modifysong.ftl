    ...
    <form class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${song.song_name}" placeholder="" id="songname"
                       name="songname">
            </div>
        </div>
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="singername" id="singername">
                    <#list singerList as singer>
                        <#if song.songSinger==singer.getId()>
                            <option value="${singer.getId()}" selected>${singer.singerName}</option>
                            <#else >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" value="${song.song_release}"
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="albumname" id="albumname">
                    ...
                    <#list albumlist as album>
                        <#if song.getAlbum().albumId==album.albumId>
                            <option selected value="${album.getAlbumId()}">${album.getAlbumName()}</option>
                        <#else >
                        ...
                        <dl class="cl permission-list2" id="permission-list2">
                            <#list labelList as label>
                                <dt>
                                    <label class="">
                                        <#assign x=0 >
                                        <#list songLabels as singerLabel>
...
<script type="text/javascript">
    ...
    function ajaxsubmit() {
        ...
        myform.append('songId',${song.songId});
        $.ajax({
            url: "/back/tomodifysong",
            type: "POST",
            data: myform,
            async: false,
            contentType: false,
