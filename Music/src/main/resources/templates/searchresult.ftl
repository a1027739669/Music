...
<head>
    ...
    <script type="text/javascript" src="/js/xiamiindex.js"></script>
...
<body data-spm="12028335">
<div id="app">
    <div class="page-container">
        <div class="content-wrapper">
            <div class="search-view view-without-leftbar">
                <div class="search-header" data-spm-anchor-id="a2oj1.12028335.0.i0.40682791w46EAI"><h2>搜索结果</h2>
                    <div class="tabs unselectable" id="searchlabel">
                        <div class="tab active" onclick="searchSong(this)">歌曲</div>
                        <div class="tab" onclick="seatchSinger(this)">歌手</div>
                        <div class="tab" onclick="searchAlbum(this)">专辑</div>
                        <div class="tab" onclick="searchSheet(this)">歌单</div>
                        <div class="tab" onclick="searchUser(this)">用户</div>
                    </div>
                </div>
...
<div class="mod_operate_menu" style="position: absolute; display: none; left: 434px; top: 594px;" id="fav_pop">
    <div class="operate_menu__cont">
        ...
        <a onclick="addtonewsheet()" class="operate_menu__link js_addto_new"><i class="operate_menu__icon_add sprite"></i>添加到新歌单</a>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result != "登录成功") {
                        ...
                        window.location.href = "/guest/search?info=" + '${info}';
                        layer.msg("登录成功!");
                    }
                },
                error: function () {
...
<script type="text/javascript">
    ...
    function seatchSinger(t) {
        var key = '${info}';
        $('#searchlabel div').each(function (index, item) {
