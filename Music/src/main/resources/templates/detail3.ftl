    ...
    <div class="mod_data" style="display:block;">
        ...
        <div class="data__cont">
            ...
            <div class="product-price">
                ...
                <div class="product-price-info">
<#--                    <a>流派：${s}&nbsp&nbsp&nbsp&nbsp&nbsp</a>-->
                    <a>发行时间：${song.song_release} &nbsp&nbsp&nbsp&nbsp&nbsp</a>
                </div>
            </div><!--end product-price-->
            <div class="data__actions" role="toolbar">
                <a href="//y.qq.com/portal/player.html" class="mod_btn_green js_all_play">播放</a>
                ...
                <a href="javascript:;" class="mod_btn js_more" data-stat="y_new.song.header.more" data-id="240935550"
                   data-songtype="0" data-mid="001xCrdG4dHbpD">更多</a>
        ...
        <div class="detail_layout__main">
            ...
            <div class="mod_lyric">
                ...
                <div class="lyric__hd">
                   ...
                   <label> ghsoihgsogdhsdgoidgshdgssdgklhdshgdhfdjgjd  </label>
                    <label>gdadsgsdhsdhhsshsgd  </label>
                   <label> gaagagag
                        </label>
                </textarea>
                </div>
