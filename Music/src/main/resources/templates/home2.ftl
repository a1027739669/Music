        ...
        <div class="content-wrapper">
            <div class="my-music-view">
                ...
                <div class="view-body">
                        ...
                        <div>
                            <div class="adaptive-list" style="opacity: 1;">
                                <div class="collect-item unselectable" style="flex: 0 0 20%; max-width: 20%;">
                                    <div class="wrapper"><a href="https://www.xiami.com/collect/1022094148">
                                            <div class="cover"
                                                 style="background-image: url(songImg/1.jpg);">
                                                <div class="count"><i class="iconfont"></i>0</div>
                                                <div class="action">
                                    ...
                                    <div class="info">
                                        <div class="name"><a href="https://www.xiami.com/collect/1022094148">fsafa</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="collect-item unselectable" style="flex: 0 0 20%; max-width: 20%;">
                                    <div class="wrapper"><a href="https://www.xiami.com/collect/1022094148">
                                            <div class="cover"
                                                 style="background-image: url(songImg/3.jpg);">
                                                <div class="count"><i class="iconfont"></i>0</div>
                                                <div class="action">
                                                    <button class="play"><i class="iconfont"></i></button>
                                                </div>
                                ...
                                <div class="collect-item unselectable" style="flex: 0 0 20%; max-width: 20%;">
                                    <div class="wrapper"><a href="https://www.xiami.com/collect/1022094148">
                                            <div class="cover"
                                                 style="background-image: url(songImg/2.jpg);">
                                                <div class="count"><i class="iconfont"></i>0</div>
                                                <div class="action">
                                                    <button class="play"><i class="iconfont"></i></button>
                                                </div>
                    ...
                    <div class="collect-list">
                        <div class="block-title unselectable"><h2>收藏的歌单 1</h2>
                            ...
                            <div class="adaptive-list" style="opacity: 1;">
                                <div class="collect-item unselectable" style="flex: 0 0 20%; max-width: 20%;">
                                    <div class="wrapper"><a href="https://www.xiami.com/collect/365764247">
                                            <div class="cover"
                                                 style="background-image: url(songImg/2.jpg);">
                                                <div class="count"><i class="iconfont"></i>6.1万</div>
                                                <div class="action">
                                                    <button class="play"><i class="iconfont"></i></button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="info">
                                        <div class="name"><a href="https://www.xiami.com/collect/365764247">偷吃可爱长大</a>
                                        </div>
                                        <div class="author"><a href="https://www.xiami.com/user/52300480">大明湖畔的窜天猴</a>
                                        </div>
                                        <div class="song-tags" data-spm="songtags"><span class="tag-tag"><a
                                                        href="https://www.xiami.com/list/collect?tag=%E5%8F%AF%E7%88%B1">可爱</a><span>、</span></span><span
                                                    class="tag-tag"><a
                                                        href="https://www.xiami.com/list/collect?tag=%E6%9C%89%E8%B6%A3">有趣</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="main-block">
                        <div class="info-panel">
                            ...
                            <div class="info">
                                ...
                                <div class="info-value">
                                    <div class="links"><a href="https://emumo.xiami.com/wiki/addalbum" target="_blank"
                                                          rel="noreferrer noopener">添加资料</a><a
                                                href="https://emumo.xiami.com/music/want" target="_blank"
                                                rel="noreferrer noopener">大家想要的专辑</a><a
                                                href="https://emumo.xiami.com/space/upload-audio" target="_blank"
                                                rel="noreferrer noopener">音频上传</a><a
                                                href="https://link.xiami.com/mv/myMv" target="_blank"
                                                rel="noreferrer noopener">MV上传</a></div>
                                </div>
                            </div>
                            <div class="info">
                                <div class="info-name">桌面端</div>
                                <div class="info-value">
                                    <div class="links"><a target="_self" rel="noreferrer noopener">PC电脑</a><a
                        ...
                        <div class="app-qrcode-container">
                            ...
                            <img class="app-qrcode"
                                 src="./虾米音乐 - 发现音乐新世界_files/TB1td6jIpOWBuNjy0FiXXXFxVXa-300-300.png"></div>
                    </div>
                ...
                <div class="play-bar" style="background-color:#FFF;box-shadow:0 1px 0 inset #F2F2F2">
                    <div class="music"><a class="cover-link" href="https://www.xiami.com/song/undefined">
                            <div class="transitive-image unselectable"><img class="active" src="about:blank"><img
                                        class="" src="https://www.xiami.com/user/430803050"></div>
                        </a>
                        <div class="info">
                            <div class="scroll">
...
<script src="./虾米音乐 - 发现音乐新世界_files/es6-promise.min.js.下载"></script>
<script src="./虾米音乐 - 发现音乐新世界_files/sufei-seed.js.下载"></script>
<script type="text/javascript" src="./虾米音乐 - 发现音乐新世界_files/aplus_v2.js.下载" async="" defer=""></script>

<script type="text/javascript" src="./虾米音乐 - 发现音乐新世界_files/index.js(3).下载"></script>
