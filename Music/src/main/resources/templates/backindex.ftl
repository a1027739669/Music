...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div class="logo">
				<a href="./backindex.ftl">WeAdmin v1.0</a>
			</div>
			<div class="left_open">
			...
			<ul class="layui-nav right" lay-filter="">
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
						...
						<dd>
							<a onclick="WeAdminShow('切换帐号','./backlogin.ftl')">切换帐号</a>
						</dd>
						<dd>
							<a class="loginout" href="./backlogin.ftl">退出</a>
						</dd>
					</dl>
				</li>
...
//			});
			...
			layui.use(['jquery', 'admin', 'menu'], function(){
				...
				$(function(){
					...
					if(login){
						if(login===0){
							// window.location.href='backlogin.ftl';
							return false;
						}else{
							return false;
						}
