 ...
 * @Author: 章宇翔
 * @CreateDate: 2019/11/17 18:34
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/11/17 18:34
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class AliyunSMS {
    ...
    static final String accessKeySecret = "USZKSNxbh2Bsiz9IgAdCb8OGBGZ2GT";   // TODO 修改成自己的
    public static SendSmsResponse sendSms(String telephone, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("我的音乐网站注册验证码");    // TODO 修改成自己的
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_171119553");    // TODO 修改成自己的
